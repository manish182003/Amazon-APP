...
import 'package:amazon_app/features/search/services/searchservices.dart';
import 'package:amazon_app/features/search/widgets/searchproduct.dart';
import 'package:amazon_app/models/product.dart';
import 'package:flutter/material.dart';

class SearchScreen extends StatefulWidget {
  static const String route = '/search-screen';
  final String searchqury;
  const SearchScreen({
    Key? key,
    required this.searchqury,
  }) : super(key: key);
